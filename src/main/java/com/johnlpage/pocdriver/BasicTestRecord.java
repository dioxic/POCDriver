...
public class BasicTestRecord implements TestRecord {
	...
	BasicTestRecord(POCTestOptions testOpts) {
	...
	BasicTestRecord(int nFields, int depth, int stringLength, int workerID, int sequence, long numberSize, int[] array, int binsize) {
